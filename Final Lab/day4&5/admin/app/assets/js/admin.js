function showSection(section) {
    ...
    if (section === "changePasswordSection") {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (searchBtn) {
        searchBtn.addEventListener("click", function () {
            ...
            fetch("../../controllers/userController/searchUser.php", {
                method: "POST",
                headers: {
    ...
    if (searchCourseBtn) {
        searchCourseBtn.addEventListener("click", function () {
            ...
            fetch("../../controllers/courseController/searchCourse.php", {
                method: "POST",
                headers: {
                    "Content-Type": "application/x-www-form-urlencoded"
                },
...
function downloadRevenueCSV(type) {
    // Create a form to submit the download request
    const form = document.createElement('form');
    form.method = 'POST';
    form.action = '../../controllers/revenueController/exportRevenue.php';
